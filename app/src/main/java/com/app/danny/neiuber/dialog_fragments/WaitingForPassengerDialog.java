...
public class WaitingForPassengerDialog extends DialogFragment {
    ...
    public ArriveButtonClicked buttonClicked;


    View dialogView;

    public WaitingForPassengerDialog() {
    ...
    public interface ArriveButtonClicked {
        void onButtonClicked(boolean accepted);
    }
    ...
    public void onAttach(Context context) {
        ...
        try{
            buttonClicked = (ArriveButtonClicked) getTargetFragment();
