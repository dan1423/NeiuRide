...
public class DroppingOffPassenger extends DialogFragment {
    ...
    public DropButtonClicked buttonClicked;


    View dialogView;

    public DroppingOffPassenger() {
    ...
    public interface DropButtonClicked {
    ...
    public void onAttach(Context context) {
        ...
        try{
            buttonClicked = (DropButtonClicked) getTargetFragment();
